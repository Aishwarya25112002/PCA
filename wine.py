# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 20:29:47 2023

@author: hp
"""
'''     
Business Objective:
maximize: A composite measure of wine quality, 
          potentially derived from expert ratings or
          sensory evaluations.
...
1. 'Type':
   ...
   - Categories:1, 2, 3, or 'Red', 'White', 'Rose'.
...
#######################################
df.columns#show the all columns
'''
...
'''
#######################################
df.dtypes #show the type of data
